...
ProTheme::ProTheme(/* args */)
{
	...
	col_dark_ctrl           = RGB15(28,28,28)|BIT(15); // RGB15(31,31,31)|BIT(15)
	col_light_ctrl_disabled = col_light_bg;
	col_dark_ctrl_disabled  = col_medium_bg;
	col_list_highlight1     = RGB15(24,24,24)|BIT(15); // part of the gradient
	col_list_highlight2     = RGB15(30,30,30)|BIT(15);
