...
PatternView::PatternView(u8 _x, u8 _y, u8 _width, u8 _height, uint16 **_vram, State *_state)
	...
	col_lines(RGB15(6,6,6)|BIT(15)),
	col_sublines(RGB15(20,20,20)|BIT(15)),
	col_lines_record(RGB15(31,18,0)|BIT(15)),
	cb_col1(RGB15(20,20,20)|BIT(15)),
	cb_col2(RGB15(24,24,24)|BIT(15)),
	cb_col1_highlight(RGB15(8,9,12)|BIT(15)),
	cb_col2_highlight(RGB15(7,14,22)|BIT(15)),
	col_left_numbers(RGB15(12,12,12)|BIT(15)),
	col_notes(RGB15(0,0,0)|BIT(15)),
	col_instr(RGB15(16,16,16)|BIT(15)),
	col_volume(RGB15(16,16,16)|BIT(15)),
	col_notes_dark(RGB15(0,6,26)|BIT(15)),
	col_instr_dark(RGB15(20,6,0)|BIT(15)),
	col_volume_dark(RGB15(0,16,0)|BIT(15)),
	col_bg(RGB15(31,31,31)|BIT(15)),
