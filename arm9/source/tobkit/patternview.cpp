...
PatternView::PatternView(u8 _x, u8 _y, u8 _width, u8 _height, uint16 **_vram, State *_state)
	...
	col_lines(RGB15(15,15,15)|BIT(15)),
	col_sublines(RGB15(3,3,3)|BIT(15)),
	col_lines_record(RGB15(31,18,0)|BIT(15)),
	cb_col1(RGB15(10,10,10)|BIT(15)),
	cb_col2(RGB15(12,12,12)|BIT(15)),
	cb_col1_highlight(RGB15(8,9,12)|BIT(15)),
	cb_col2_highlight(RGB15(7,14,22)|BIT(15)),
	col_left_numbers(RGB15(28,28,28)|BIT(15)),
	col_notes(RGB15(31,31,31)|BIT(15)),
	col_instr(RGB15(24,24,24)|BIT(15)),
